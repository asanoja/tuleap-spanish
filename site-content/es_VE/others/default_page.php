...
<html>
    ...
    <body>
        <div class="container">
            <p>
                <a href="http://<?= $default_domain; ?>/"><b>Inicio</b></a> |
                <a href="http://<?= $default_domain; ?>/contact.php"><b>Contáctenos</b></a> |
                <a href="http://<?= $default_domain; ?>/account/logout.php"><b>Salir</b></a>
            </p>
            <div class="hero-unit">
                <img src="http://<?= $default_domain; ?>/themes/common/images/organization_logo.png" vspace="" hspace="7" border=0 alt="Organization logo">

                <h2>Bienvenido al sitio Web del proyecto <?= $project_name ?></h2>
                <p>Este proyecto no ha definido una pagina principal. Este pendiente por cualquier cambio o actualización visitando la <A href="http://<?= $default_domain; ?>/projects/<?= $project_name; ?>">página resumen del proyecto</a></p>
            </div>
        </div>
    </body>
</html>
